    ...
    <div class="container">
        ...
        <div class="user-list">
            ...
            <?php
                ...
                {
                    $counter++;
                    echo "<button type='submit' name='submit' class='user-item'>
                            <p><strong>Nazwa:</strong> " . $uDatabase[$memberID - 1]->getName() . "</p>
                        </button>";
                }
        ...
        <a href="../ManageUserGroup/AddUser/index.php" class="back-button">Dodaj użytkownika</a>
        <a href="../ManageUserGroup/DeleteUser/index.php" class="back-button">Usuń użytkownika</a>
        <a href="../GroupsPanel/index.php" class="back-button">Powrót</a>
    </div>
</body>
</html>
